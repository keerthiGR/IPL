...
public class IPL {
	public static void main(String args[]) {
		...
		for(Team f:finalteam) {								
			totalteam++;								//Here i,m calculating the number of concecutive loss teams and the total points and i'm printing the name of the team 
			System.out.println(f.Name);
			totalpoints=totalpoints+f.points;
		}
		
		if(totalteam>0) {								
			int avg=totalpoints/totalteam;				//Here i'm calculating the average points of filtered team
